...
import pl.biblioteka.library.exception.*;
...
import pl.biblioteka.library.io.file.FileManager;
import pl.biblioteka.library.io.file.FileManagerBuilder;
...
class LibraryControl {
    ...
    private void deleteMagazine(){
        try{
            ...
            printer.printLine("Nie udało się odnalezc magazynu,niepoprawne dane");
        }
    }
    ...
    private void deleteBook(){
        try{
            ...
            printer.printLine("Nie udało sie odnalezc książki, niepoprawne dane");
        }
    }
